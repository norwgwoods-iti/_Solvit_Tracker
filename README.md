...
Раскройте тег Установка Базы Данных 💽.
...
Убедитесь, что сервер FastAPI запущен и принимает запросы на http://localhost:8000.
Откройте файл index.html прямо в вашем браузере (двойным кликом или через расширение Live Server в VS Code).
